...
public class DosirakBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    public void btn_gpsClicked (View v){
        ...
        Intent intent = new Intent(DosirakBoard.this, DosirakShare.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStore.collection("dosirakboard").get()
    ...
    public void onClick(View v) {
        startActivity(new Intent(this,DosirakWriteActivity.class));
    }
