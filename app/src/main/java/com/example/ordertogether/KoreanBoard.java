...
public class KoreanBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    public void btn_gpsClicked (View v){
        ...
        Intent intent = new Intent(KoreanBoard.this, KoreanShare.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStore.collection("koreanboard").get()
    ...
    public void onClick(View v) {
        startActivity(new Intent(this,KoreanWriteActivity.class));
    }
