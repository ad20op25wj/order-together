...
public class ChickenBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    public void btn_gpsClicked (View v){
        ...
        Intent intent = new Intent(ChickenBoard.this, ChickenShare.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStore.collection("chickenboard").get()
    ...
    public void onClick(View v) {
        startActivity(new Intent(this, ChickenWriteActivity.class));
    }
