...
public class ChineseBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStore.collection("chineseboard").get()
    ...
    public void onClick(View v) {
        startActivity(new Intent(this,ChineseWriteActivity.class));
    }
