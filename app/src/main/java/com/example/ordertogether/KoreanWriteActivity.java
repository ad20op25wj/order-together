...
public class KoreanWriteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        id = mStore.collection("koreanboard").document().getId();
        ...
        mStore.collection("koreanboard").document(id).set(post)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(KoreanWriteActivity.this, "업로드 성공!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                })
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(KoreanWriteActivity.this, "업로드 실패!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
